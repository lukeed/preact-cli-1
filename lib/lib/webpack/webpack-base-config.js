...
exports.default = function (env) {
	...
	return {
		...
		plugins: [new _webpack2.default.NoEmitOnErrorsPlugin(), new _webpack2.default.DefinePlugin({
			...
			summary: false,
			clear: true
		})].concat(isProd ? [new _webpack2.default.HashedModuleIdsPlugin(), new _webpack2.default.LoaderOptionsPlugin({ minimize: true }), new _webpack2.default.optimize.ModuleConcatenationPlugin(), new _webpackChunkHash2.default(), new _webpackPluginReplace2.default({
